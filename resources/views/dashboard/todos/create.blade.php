    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="main-dashboard-header-right">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li class="breadcrumb-item active">@lang('main.add_todo')</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.todos.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" name="description" id="description" type="text" class="form-control" placeholder="Add a Description"></textarea>
                            </div>
